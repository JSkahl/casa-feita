# Casa Feita - Projeto Integrador

Um modelo para o desenvolvimento do Projeto Integrador do Curso de Técnico em Desenvolvimento de Sistemas para a Internet Integrado ao Ensino Médio do IFC - Campus Araquari. A Casa Feita é uma plataforma de e-commerce especializada na venda de móveis, projetada para oferecer uma experiência de usuário otimizada e eficiente. Com uma interface amigável e intuitiva, o site permite que os clientes naveguem facilmente por um catálogo abrangente que inclui móveis para todos os ambientes residenciais. A Casa Feita combina qualidade, conveniência e inovação para atender às demandas do mercado de móveis online.
...
# 1. Desenvolvimento
Nosso cliente possui uma loja online de móveis chamada Casa Feita, que tem se destacado pela qualidade e variedade de seus produtos, resultando em um rápido crescimento. Recentemente, ele expandiu sua equipe, contratando mais funcionários para o atendimento ao cliente, gerenciamento de estoque, logística e marketing digital. Com essa estrutura em crescimento, ele agora pode focar na melhoria da gestão da loja. Para isso, ele deseja implementar um sistema de e-commerce robusto que permita um gerenciamento eficiente das vendas. Este sistema permitirá que os clientes naveguem facilmente pelo catálogo de produtos, façam compras de forma segura e rápida, e que o estoque seja atualizado em tempo real. 

# 2. Situação Problema

Atualmente, a Casa Feita enfrenta vários desafios em seu dia-a-dia operacional. O gerenciamento do estoque é feito manualmente, o que muitas vezes resulta em discrepâncias entre os produtos disponíveis no site e os que realmente estão no depósito. Isso causa atrasos nas entregas e insatisfação dos clientes. A equipe de atendimento ao cliente, apesar de dedicada, lida com um volume crescente de consultas e reclamações, muitas vezes relacionadas a problemas de estoque e atrasos.
Além disso, o processo de venda online não é totalmente automatizado. As transações são registradas manualmente, o que não só é demorado, mas também propenso a erros humanos. Isso afeta a precisão dos registros de vendas e complica a geração de relatórios financeiros. O marketing digital, embora eficaz em atrair novos clientes, não tem um sistema integrado para monitorar o retorno sobre investimento (ROI) das campanhas, dificultando a otimização das estratégias de marketing.
A falta de um sistema integrado de gestão impede a Casa Feita de obter uma visão completa e em tempo real do desempenho da loja. Nosso cliente tem dificuldade em analisar dados críticos para tomar decisões informadas sobre estoque, vendas e marketing. A ausência de relatórios detalhados também limita a capacidade de identificar tendências de mercado e comportamentos dos clientes.

# 3. Descrição da proposta

Para resolver os problemas enfrentados pela Casa Feita, propomos a implementação de um sistema de e-commerce integrado que atenda a todas as necessidades operacionais e de gestão da loja. Este sistema será desenvolvido para automatizar a gestão de estoque, proporcionando atualizações em tempo real conforme as vendas são realizadas, o que garantirá a precisão dos níveis de estoque e reduzirá discrepâncias. A integração com o sistema de pedidos permitirá uma gestão mais eficiente, enviando alertas automáticos para reposição de produtos quando necessário, evitando assim atrasos nas entregas e insatisfação dos clientes.
...
<img src="Casa Feita (Modelo ER básico).png">
